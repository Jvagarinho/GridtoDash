...
TRANSLATIONS = {
    "pt": {
        ...
        "sidebar_built_with": "Feito por IterioTech",
    ...
    "en": {
        ...
        "sidebar_built_with": "Built by IterioTech",
...
def main():
    ...
    with st.sidebar:
        ...
        with col_lang1:
            if st.button("PT", width='stretch', type="primary" if st.session_state.language == "pt" else "secondary"):
                st.session_state.language = "pt"
                st.rerun()
        with col_lang2:
            if st.button("EN", width='stretch', type="primary" if st.session_state.language == "en" else "secondary"):
    ...
    if uploaded_file is not None:
        try:
            ...
            st.dataframe(df[pdf_columns].head(10), width='stretch')
